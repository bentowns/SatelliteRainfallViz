...
#-------------------------------------------------------------------------------
#Required Packages
library(terra) #processing/visualization
library(rnaturalearth) #Ghana shapefile
library(chirps) #chirps data
library(sf) #Processing
library(tidyverse)
library(sfheaders)
#-------------------------------------------------------------------------------
...
Ghana <- ne_countries(country = "Ghana")
...
#convert wet days from -1 to 1
for (i in 1:30){
  ExtremeWetDays[[i]][ExtremeWetDays[[i]] == -1 ] = 1
}
...
#Define Functions
#-------------------------------------------------------------------------------
#Create a function to fast track cropping
...
#Transform ghana shapefile into sf
Ghana <- st_as_sf(Ghana)
#-------------------------------------------------------------------------------
#ggplot
#-------------------------------------------------------------------------------
